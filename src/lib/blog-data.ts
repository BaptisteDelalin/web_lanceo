...
Identifiez vos sources de revenus, votre structure de coûts, votre pricing et vos marges prévisionnelles. Pour vous aider dans cette réflexion, [découvrez nos offres d'accompagnement](/offres) adaptées à chaque étape de votre projet.
...
Structurer son projet, c'est se donner les moyens de réussir. Ce n'est pas brider la créativité, c'est lui donner un cadre pour s'exprimer pleinement. Si vous sentez que vous avez besoin d'un regard extérieur pour franchir ces étapes, [réservez un appel découverte](/rendez-vous) pour en discuter ensemble.
    `,
  },
  {
...
Un modèle économique viable, c'est un modèle que vous comprenez parfaitement, que vous pouvez expliquer simplement et qui résiste à l'épreuve des chiffres. Prenez le temps de le construire solidement. Nous pouvons vous y aider : [consultez nos offres](/offres) pour trouver la formule qui vous correspond, ou [prenez rendez-vous](/rendez-vous) pour un échange personnalisé.
    `,
  },
  {
...
L'entrepreneuriat peut être solitaire. Ne restez pas seul : entourez-vous, faites-vous accompagner, rejoignez des communautés. Si vous cherchez un accompagnement structuré, [découvrez nos offres](/offres) conçues pour les entrepreneurs en phase de lancement.
...
Faire des erreurs fait partie du jeu. L'important est d'en tirer des leçons et d'avancer. Et si vous sentez que vous avez besoin d'un guide pour naviguer ces défis, c'est exactement pour cela que Lanceo Access existe. [Réservez un appel découverte gratuit](/rendez-vous) pour en discuter.
    `,
  },
];
